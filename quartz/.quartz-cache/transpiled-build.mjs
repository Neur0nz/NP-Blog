...
/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */`;var toc_default=`button#toc {
  background-color: transparent;
  border: none;
  text-align: left;
  cursor: pointer;
...
/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */`;var giscus_inline_default=`var o=!0;function a(e){let t=document.querySelector("iframe.giscus-frame");t&&t.contentWindow.postMessage({giscus:e},"https://giscus.app")}var n=()=>{let e=document.querySelector("#darkmode-toggle");s(e.checked)};function r(e){a({setConfig:{term:e}})}function s(e){a({setConfig:{theme:e?"noborder_dark":"noborder_light"}})}function i(){let e=document.querySelector("#darkmode-toggle"),t=document.createElement("script");t.type="text/javascript",t.src="https://giscus.app/client.js",t.async=!0,t.setAttribute("data-repo","Neur0nz/NP-Blog"),t.setAttribute("data-repo-id","R_kgDOMGTkgQ"),t.setAttribute("data-category","Comments"),t.setAttribute("data-category-id","DIC_kwDOMGTkgc4CgGgv"),t.setAttribute("data-mapping","pathname"),t.setAttribute("data-strict","0"),t.setAttribute("data-reactions-enabled","1"),t.setAttribute("data-emit-metadata","0"),t.setAttribute("data-input-position","top"),t.setAttribute("data-theme",e.checked?"noborder_dark":"noborder_light"),t.setAttribute("data-lang","en"),t.setAttribute("crossorigin","anonymous"),t.setAttribute("data-loading","lazy"),document.body.appendChild(t),console.log("appended")}document.addEventListener("nav",({detail:e})=>{if(o){let t=document.querySelector("#darkmode-toggle");t.addEventListener("change",n),window.addCleanup(()=>t.removeEventListener("change",n)),e.url!=="index"&&i()}r(e.url)});
`;import{jsx as jsx31,jsxs as jsxs18}from"preact/jsx-runtime";var Comments_default=__name(opts=>{let Comments=__name(({displayClass,cfg})=>jsxs18("footer",{class:`${displayClass??"comments"}`,children:[jsx31("hr",{}),jsx31("div",{class:"giscus"})]}),"Comments");return Comments.afterDOMLoaded=giscus_inline_default,Comments.css=comments_default,console.log(giscus_inline_default),Comments},"default");var links_default=`links {
  text-align: left;
  margin-bottom: 4rem;
  opacity: 0.7;
  align-self: stretch;
...
/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */`;import{Features,transform}from"lightningcss";import{transform as transpile}from"esbuild";function getComponentResources(ctx){let allComponents=new Set;for(let emitter of ctx.cfg.plugins.emitters){let components=emitter.getQuartzComponents(ctx);for(let component of components)allComponents.add(component)}let componentResources={css:new Set,beforeDOMLoaded:new Set,afterDOMLoaded:new Set};for(let component of allComponents){let{css,beforeDOMLoaded,afterDOMLoaded}=component;css&&componentResources.css.add(css),beforeDOMLoaded&&componentResources.beforeDOMLoaded.add(beforeDOMLoaded),afterDOMLoaded&&componentResources.afterDOMLoaded.add(afterDOMLoaded)}return{css:[...componentResources.css],beforeDOMLoaded:[...componentResources.beforeDOMLoaded],afterDOMLoaded:[...componentResources.afterDOMLoaded]}}__name(getComponentResources,"getComponentResources");async function joinScripts(scripts){let script=scripts.map(script2=>`(function () {${script2}})();`).join(`
